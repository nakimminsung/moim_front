...
function BookingDetailRight({bookingList}) {
	...
	const submitHandler3 = (e) => {
		...
		let updateUrl = localStorage.url + `/host/bookingStatusUpdate`;
		console.log(updateUrl);
		console.log('num' + num);
		let data = {
			num,
				...
				<div className='BKItem'>
					...
					<div className='bdPrice'>
						<div>
							<p>
								예약날짜&nbsp;&nbsp;
								<b>{bookingList.bookingDate}</b>
							</p>
							<div style={{display: 'flex', marginBottom: '0'}}>
								<p>
									예약시간&nbsp;&nbsp;
									<b>{bookingList.bookingTime}&nbsp;(시)</b>
									&nbsp;&nbsp;
								</p>
							</div>
...
export default BookingDetailRight;
